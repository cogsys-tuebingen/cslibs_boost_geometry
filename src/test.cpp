...
void TEST_9_DISTANCE()
{
    ...
    assert(equal(distance<double, Point2d>(test_pt1, test_line), 0., 1e-3));
    assert(equal(distance<double, Point2d>(test_pt2, test_line), 1., 1e-3));
    assert(equal(distance<double, Point2d>(test_pt3, test_line), 1., 1e-3));
    assert(equal(distance<double, Point2d>(test_pt4, test_line), sqrt(2), 1e-3));
...
void TEST_12_ANGLES()
{
    ...
    assert(equal(angle<double, Point2d>(l11, l21, 1e-3), M_PI / 2.0, 1e-3));
    assert(equal(angle<double, Point2d>(l11, l22, 1e-3), M_PI / 2.0, 1e-3));
    assert(equal(angle<double, Point2d>(l12, l21, 1e-3), M_PI / 2.0, 1e-3));
    assert(equal(angle<double, Point2d>(l12, l22, 1e-3), M_PI / 2.0, 1e-3));

    assert(equal(angle<double, Point2d>(l31, l41, 1e-3), 135. / 180. * M_PI, 1e-3));
    assert(equal(angle<double, Point2d>(l31, l42, 1e-3), 135. / 180. * M_PI, 1e-3));
    assert(equal(angle<double, Point2d>(l32, l41, 1e-3), 135. / 180. * M_PI, 1e-3));
    assert(equal(angle<double, Point2d>(l32, l42, 1e-3), 135. / 180. * M_PI, 1e-3));

    assert(equal(angle<double, Point2d>(l31, l21, 1e-3), 45. / 180. * M_PI, 1e-3));
    assert(equal(angle<double, Point2d>(l31, l22, 1e-3), 45. / 180. * M_PI, 1e-3));
    assert(equal(angle<double, Point2d>(l32, l21, 1e-3), 45. / 180. * M_PI, 1e-3));
    assert(equal(angle<double, Point2d>(l32, l22, 1e-3), 45. / 180. * M_PI, 1e-3));

    assert(equal(angle<double, Point2d>(l31, l51, 1e-3), 135. / 180. * M_PI, 1e-3));
    assert(equal(angle<double, Point2d>(l31, l52, 1e-3), 135. / 180. * M_PI, 1e-3));
    assert(equal(angle<double, Point2d>(l32, l51, 1e-3), 135. / 180. * M_PI, 1e-3));
    assert(equal(angle<double, Point2d>(l32, l52, 1e-3), 135. / 180. * M_PI, 1e-3));

    assert(equal(angle<double, Point2d>(l31, l61, 1e-3), 45. / 180. * M_PI, 1e-3));
    assert(equal(angle<double, Point2d>(l31, l62, 1e-3), 45. / 180. * M_PI, 1e-3));
    assert(equal(angle<double, Point2d>(l32, l61, 1e-3), 45. / 180. * M_PI, 1e-3));
    assert(equal(angle<double, Point2d>(l32, l62, 1e-3), 45. / 180. * M_PI, 1e-3));

    assert(equal(angle<double, Point2d>(l31, l32, 1e-3), 0.0, 1e-3));
    assert(equal(angle<double, Point2d>(l32, l31, 1e-3), 0.0, 1e-3));
